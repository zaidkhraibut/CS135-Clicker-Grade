...
appendElement("td", totalClickerPercentage+"%"+" | <strong>W: "+weightedClickerMark+"</strong>", clickerMarksRow);


// Add content of the third element of a specificed row onto the next 3rd element
// of each row  until it reaches the the end of the table
